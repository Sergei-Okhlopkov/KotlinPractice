...
class ImageAndText : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val rView = view?.findViewById<RecyclerView>(R.id.imageAndTextRecycyler)
        rView?.layoutManager = LinearLayoutManager(context)
        rView?.adapter = RecyclerAdapterImageAndText(textsList,imagesList)
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_image_and_text, container, false)
    }
